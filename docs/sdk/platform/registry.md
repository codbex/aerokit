...
> `any`[]
> 
> The resource content as a JavaScript byte array.
> 
> ##### getContentNative()
> 
> > ```ts
...
> `any`[]
> 
> The resource content as a native Java byte array.
> 
> ##### getText()
> 
> > ```ts
...
> `string`[]
> 
> An array of registry paths (strings) that match the search criteria.
> 
> ##### getRoot()
> 
> > ```ts
...
> > `string`[]
> 
> > An array of sub-directory names.
> 
> > ##### getDirectory()
> 
> > > ```ts
